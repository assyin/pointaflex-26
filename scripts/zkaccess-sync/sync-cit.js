/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * SYNCHRONISATION DIRECTE - TERMINAL ZKTECO CIT → POINTAFLEX
 * ═══════════════════════════════════════════════════════════════════════════════
 */
...
const CONFIG = {
  ...
  pointaflex: {
    apiUrl: 'http://127.0.0.1:3000/api/v1/attendance/webhook/fast',
    deviceId: 'EJB8241100244',
    tenantId: '340a6c2a-160e-4f4b-917e-6eea8fd5ff2d',
    apiKey: 'pk_c3e826fdeced8268d614893dd84f4615e34bf057e1882d7cc6960b9f18b2a68b',
  },
  sync: {
    intervalSeconds: 30,
    lastSyncFile: './last_sync_cit.json',
    logFile: './sync_cit.log',
    daysBack: 0,  // Uniquement aujourd'hui
  },
};
...
async function syncOnce() {
  ...
  try {
    ...
    minDate.setHours(0, 0, 0, 0);  // Début de la journée (minuit)
