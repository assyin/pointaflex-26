/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * SYNCHRONISATION DIRECTE - TERMINAL ZKTECO CP → POINTAFLEX
 * ═══════════════════════════════════════════════════════════════════════════════
 */
...
const CONFIG = {
  ...
  pointaflex: {
    ...
    apiKey: 'pk_68ff73113d5ef604654e8276ac588fdad383e78d0222f3616af64a5e79fec739',
  },
  sync: {
    intervalSeconds: 30,
    lastSyncFile: './last_sync_cp.json',
    logFile: './sync_cp.log',
...
async function main() {
  console.log('\n═══════════════════════════════════════════════════════════════════');
  console.log('   SYNCHRONISATION DIRECTE - ZKTECO CP → POINTAFLEX');
  console.log('═══════════════════════════════════════════════════════════════════\n');
