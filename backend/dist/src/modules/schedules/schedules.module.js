...
exports.SchedulesModule = SchedulesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [schedules_service_1.SchedulesService, alerts_service_1.AlertsService],
        exports: [schedules_service_1.SchedulesService, alerts_service_1.AlertsService],
    })
], SchedulesModule);
