...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Nom du jour férié' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateHolidayDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Date du jour férié (YYYY-MM-DD)' }),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], CreateHolidayDto.prototype, "date", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.HolidayType, description: 'Type de jour férié' }),
    (0, class_validator_1.IsEnum)(client_1.HolidayType),
    __metadata("design:type", String)
], CreateHolidayDto.prototype, "type", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Est-ce un jour récurrent (anniversaire annuel)' }),
